...
INSERT INTO `admin_menu` VALUES ('6', '/admin/user/profile', 'Profile', '用户信息', null, 'user/UserProfile', '4');
INSERT INTO `admin_menu` VALUES ('7', '/admin/user/role', 'Role', '角色配置', null, 'user/Role', '4');
INSERT INTO `admin_menu` VALUES ('8', '/admin/content/book', 'BookManagement', '订单管理', null, 'content/BookManagement', '3');
INSERT INTO `admin_menu` VALUES ('9', '/admin/content/banner', 'BannerManagement', '店铺管理', null, 'content/BannerManagement', '3');
INSERT INTO `admin_menu` VALUES ('10', '/admin/content/article', 'ArticleManagement', '成品管理', null, 'content/ArticleManagement', '3');
...
INSERT INTO `admin_permission` VALUES ('3', 'content_management', '订单管理', '/api/admin/content');

-- ----------------------------
-- Records of admin_role
-- ----------------------------
INSERT INTO `admin_role` VALUES ('1', 'sysAdmin', '系统管理员', '1');
INSERT INTO `admin_role` VALUES ('2', 'orderManager', '订单管理员', '1');
