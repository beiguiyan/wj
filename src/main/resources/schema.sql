...
CREATE TABLE `admin_menu` (
  ...
  `name_zh` varchar(64) CHARACTER SET utf8  DEFAULT NULL,
  `icon_cls` varchar(64) CHARACTER SET utf8  DEFAULT NULL,
...
CREATE TABLE `admin_permission` (
  ...
  `desc_` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE `admin_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `name_zh` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
